 ...
 * for ScpCore
 */
class LeaderboardDelegate : AbsListItemAdapterDelegate<CurSubsViewModel, MyListItem, LeaderboardDelegate.ViewHolder>() {
    ...
    override fun onBindViewHolder(item: CurSubsViewModel, viewHolder:ViewHolder, payloads: MutableList<Any>) {
