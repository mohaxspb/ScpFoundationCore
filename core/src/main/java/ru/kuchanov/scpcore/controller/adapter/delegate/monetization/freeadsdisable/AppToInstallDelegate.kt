 ...
 * for ScpCore
 */
class AppToInstallDelegate(val clickListener: (String) -> Unit) : AbsListItemAdapterDelegate<AppToInstallViewModel, MyListItem, AppToInstallDelegate.ViewHolder>() {

    override fun isForViewType(item: MyListItem, items: MutableList<MyListItem>, position: Int) = item is AppToInstallViewModel

    override fun onCreateViewHolder(parent: ViewGroup) =
            ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.list_item_free_ads_simple, parent, false))

    override fun onBindViewHolder(item: AppToInstallViewModel, viewHolder: ViewHolder, payloads: MutableList<Any>) {
